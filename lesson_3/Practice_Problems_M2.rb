...
# "a_outer is 42 with an id of: 42 before the block."
# "b_outer is forty two with an id of: fourty two before the block."
# "c_outer is [42] with an id of: [42] before the block."
# "d_outer is 42 with an id of: 42 before the block."
